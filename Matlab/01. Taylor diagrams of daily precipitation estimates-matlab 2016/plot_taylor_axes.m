...
%           'fontweight',axlabweight,'fontsize',fontSize,'fontname','Times New Roman');
          text(x,y,'标准差', ...
          'rotation',90, 'color',option.colSTD, ...
          'fontweight',axlabweight,'fontsize',fontSize,'fontname','Simsun');
        else
...
%               'fontsize',fontSize,'fontname','Times New Roman');
            ylabel('标准差', ...
              'color',option.colSTD,'fontweight',axlabweight, ...
              'fontsize',fontSize,'fontname','Simsun');
        end
    end
    ...
    if strcmp(option.titleCOR,'on')
        ...
        for ic = 1 : length(c)
            ...
            set(ttt(ic),'rotation',ith-90,'color',option.colCOR, ...
                ...
                'fontsize',fontSize, ...
                'fontweight',axlabweight,'fontname','Simsun');
        end
        axes.cor.XLabel = ttt;
    end
    ...
    if strcmp(option.titleCOR,'on')
        ...
        for ic = 1 : length(c)
            ...
            set(ttt(ii),'rotation',ith-90,'color',option.colCOR, ...
                'horizontalalignment','center', ...
                'verticalalignment','bottom', ...
                'fontsize',fontSize,'fontweight',axlabweight,'fontname','Simsun');
        end
        axes.cor = ttt;
    end

...
for climate in climates:
    ...
    for earth in earths:
        ...
        for season in seasons:
            ...
            train_dem_path = 'H:\\时间预测\\四个区域可用数据\\只选用地面站点final\\02_grid_ns_data\\xunlian_features4\\' + earth + '\\dem\\' + season + '\\'
            train_lat_path = 'H:\\时间预测\\四个区域可用数据\\只选用地面站点final\\02_grid_ns_data\\xunlian_features4\\' + earth + '\\lat_wei\\' + season + '\\'
            ...
            path_random_save = 'H:\\时间预测\\四个区域可用数据\\只选用地面站点final\\result(优化lstm+不分块+加因子)\\' + earth + '\\' + season + '\\'
            ...
            test_dem_path = 'H:\\时间预测\\四个区域可用数据\\只选用地面站点final\\02_grid_ns_data\\ceshi_features4\\' + earth + '\\dem\\' + season + '\\'
            test_lat_path = 'H:\\时间预测\\四个区域可用数据\\只选用地面站点final\\02_grid_ns_data\\ceshi_features4\\' + earth + '\\lat_wei\\' + season + '\\'
            ...
            def lstm(X):
                ...
                # 二层
                cell1 = tf.nn.rnn_cell.BasicLSTMCell(rnn_unit,activation=tf.nn.tanh)

...
path_class_csv = 'H:\\青藏高原数据\\时间预测\\2015-2016(final)\\class_sumrain_12-2.csv'
...
for kind in kinds:
    ...
    names = ['dem']
    for name in names:
        path_txt ='H:\\青藏高原数据\\时间预测\\2015-2016(final)\\02_season_data\\'+ kind +'\\'+ name +'\\'+ season  +'\\'
        filelist,file_names = read_txt(path_txt)


        path_save_0 = 'H:\\青藏高原数据\\时间预测\\2015-2016(final)\\03_class_data\\'+season+'\\'+kind+'\\'+ name +'\\A\\'
        mkdir(path_save_0)
        path_save_1 = 'H:\\青藏高原数据\\时间预测\\2015-2016(final)\\03_class_data\\'+season+'\\'+kind+'\\'+ name +'\\B\\'
        mkdir(path_save_1)
        path_save_2 = 'H:\\青藏高原数据\\时间预测\\2015-2016(final)\\03_class_data\\'+season+'\\'+kind+'\\'+ name +'\\C\\'
        mkdir(path_save_2)
        path_save_3 = 'H:\\青藏高原数据\\时间预测\\2015-2016(final)\\03_class_data\\'+season+'\\'+kind+'\\'+ name +'\\D\\'
        mkdir(path_save_3)
        path_save_4 = 'H:\\时间预测\\四个区域可用数据\\banganhan\\只选用有地面站点\\03_final_ns_data\\' + earth + '\\' + season +'\\'+ kind + '\\'+ name + '\\E\\'
        mkdir(path_save_4)
        path_save_5 = 'H:\\时间预测\\四个区域可用数据\\banganhan\\03_class_data\\季节\\' + earth + '\\' + kind +'\\'+ name + '\\'+ season + '\\F\\'
        mkdir(path_save_5)
        path_save_6 = 'H:\\时间预测\\四个区域可用数据\\banganhan\\03_class_data\\季节\\' + earth + '\\' + kind +'\\'+ name + '\\'+ season + '\\G\\'
        mkdir(path_save_6)

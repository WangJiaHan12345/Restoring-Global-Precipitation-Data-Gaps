...
for climate in climates:
    ...
    for earth in earths:
        ...
        for season in seasons:
            a_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\xunlian4\\'+ earth +'\\Final\\' + season + '\\'
            # train_lat_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\xunlian_features4\\'+ earth +'\\lat_wei\\' +season + '\\'
            # train_wendu_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\xunlian_features4\\'+ earth +'\\wendu\\' +season + '\\'
            c_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\xunlian4\\'+ earth +'\\cpc\\' + season + '\\'
            d_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\xunlian4\\'+ earth +'\\Early\\' + season + '\\'
            ...
            # 还没保存结果
            path_random_save = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\result(不分块_无辅助因子)\\' + earth + '\\' + season + '\\'
            ...
            # 测试数据
            a_path_1 = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\ceshi4\\' + earth + '\\Final\\' + season + '\\'
            # test_lat_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\ceshi_features4\\' + earth + '\\lat_wei\\' + season + '\\'
            # test_wendu_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\ceshi_features4\\' + earth + '\\wendu\\' + season + '\\'
            c_path_1 = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\ceshi4\\' + earth + '\\cpc\\' + season + '\\'
            d_path_1 = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\02_grid_ns_data\\ceshi4\\' + earth + '\\Early\\' + season + '\\'

...
# 训练数据
#  整个青藏高原的gsmap_rnt训练
seasons = ['12-2']  #,'6-8','9-11','12-2'
for season in seasons:
    blocks = ['A','B','C']  #,'B','C'
    for block in blocks:
        a_path = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\xunlian\\gsmap_rnt\\'+ block +'\\'
        train_dem_path = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\xunlian\\dem\\'+ block +'\\'
        train_lat_path = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\xunlian\\lat_wei\\'+ block +'\\'
        c_path = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\xunlian\\国家气象局\\'+ block +'\\'
        d_path = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\xunlian\\gsmap_mvk\\'+ block +'\\'
        ...
        # 还没保存结果
        path_random_save = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\result\\' + season +'\\'
        ...
        # 测试数据
        a_path_1 = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\ceshi\\gsmap_rnt\\' + block + '\\'
        test_dem_path = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\ceshi\\dem\\' + block + '\\'
        test_lat_path = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\ceshi\\lat_wei\\' + block + '\\'
        c_path_1 = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\ceshi\\国家气象局\\' + block + '\\'
        d_path_1 = 'H:\\青藏高原数据\\时间预测\\2015-2016\\只含地面站点\\02_final_data\\'+season+'\\ceshi\\gsmap_mvk\\' + block + '\\'

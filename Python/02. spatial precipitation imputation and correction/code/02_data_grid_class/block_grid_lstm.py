...
earth = '北'
season = '3-5'
blocks = ['A','B','C','D','E']  #'A','B','C','D','E',
for block in blocks:
    #要不要加上坡度和坡向还有高程
    a_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\' + earth + '\\xunlian4\\final4\\' + season + '\\' + block + '\\'
    train_lat_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\'+ earth +'\\xunlian_features4\\lat_wei4\\' + season + '\\'+ block + '\\'
    train_wendu_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\'+ earth +'\\xunlian_features4\\wendu4\\' + season + '\\'+ block + '\\'
    c_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\'+ earth +'\\xunlian4\\cpc4\\' + season + '\\'+ block + '\\'
    d_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\' + earth + '\\xunlian4\\early4\\' + season + '\\' + block + '\\'
    ...
    # 还没保存结果
    path_random_save = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\result(fianl)\\季节\\' + earth + '\\' + season + '\\'
    ...
    # 测试数据
    a_path_1 = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\' + earth + '\\ceshi4\\final4\\' + season + '\\' + block + '\\'
    test_lat_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\' + earth + '\\ceshi_features4\\lat_wei4\\' + season + '\\' + block + '\\'
    test_wendu_path = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\' + earth + '\\ceshi_features4\\wendu4\\' + season + '\\' + block + '\\'
    c_path_1 = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\' + earth + '\\ceshi4\\cpc4\\' + season + '\\' + block + '\\'
    d_path_1 = 'H:\\时间预测\\四个区域可用数据\\' + climate + '\\03_class_data\\季节\\' + earth + '\\ceshi4\\early4\\' + season + '\\' + block + '\\'

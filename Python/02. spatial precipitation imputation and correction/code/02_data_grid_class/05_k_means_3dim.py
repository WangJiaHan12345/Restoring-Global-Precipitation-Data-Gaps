...
# 三种数据进行分块
path_rain_csv = "H:\\青藏高原数据\\空间\\rain_sum_12-2.csv"
data_r = read_csv(path_rain_csv)
# print(data_r)
data_rain = data_r[:, 1:]
# print(data_r)

path_dem_csv = "H:\\青藏高原数据\\空间\\dem\\dem.csv"
data_d = read_csv(path_dem_csv)
# print(data_d)
data_dem = data_d[:, 1:]
# print(data_dem)
#
path_mrdem_csv = "H:\\青藏高原数据\\空间\\dem\\MRDEM.csv"
...
t = open('H:\\青藏高原数据\\空间\\class_sumrain_12-2.txt', 'w') #得到每个点是属于第几个聚类
